    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 lg:py-40">
          <div className="max-w-2xl">
            <motion.h1
              ...
              animate="visible"
              variants={heroTitle}
              className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight uppercase leading-[1.1]"
            >
            ...
            <motion.p
              ...
              className="mt-6 text-lg md:text-xl text-c-text-secondary"
            >
      ...
      <section className="py-20 md:py-28 bg-c-surface">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <AnimateOnScroll variant={staggerContainerFast} delay={0.2}>
            <motion.div variants={staggerContainer} className="mt-10 flex flex-wrap justify-center gap-3">
              {TAGS.map((tag) => (
                <motion.div key={tag} variants={fadeInUp}>
                  <SilhouetteBadge tag={tag} href={`/shop?fit=${tag}`} size="md" />
                </motion.div>
              ))}
            </motion.div>
          </AnimateOnScroll>
      ...
      <section className="py-20 md:py-28 bg-c-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimateOnScroll variant={cardGrid} delay={0.2}>
            <motion.div variants={cardGrid} className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {OUTFIT_CARDS.map((card) => (
                <motion.div key={card.fit} variants={fadeInUp}>
                  <Link
                    href={`/shop?fit=${card.fit}`}
                    className="group p-8 bg-c-surface rounded-lg border border-c-border hover:border-c-accent hover:shadow-md transition-all block"
                  >
      ...
      <section className="py-20 md:py-28 bg-c-surface">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <AnimateOnScroll variant={sectionReveal} delay={0.2}>
              <div>
                <h2 className="font-heading text-3xl md:text-4xl font-bold uppercase tracking-tight">
      ...
      <section className="py-20 md:py-28 bg-c-surface">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimateOnScroll variant={cardGrid} delay={0.2}>
            <motion.div variants={cardGrid} className="mt-12 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      ...
      <section className="py-20 md:py-28 bg-c-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimateOnScroll variant={cardGrid} delay={0.2}>
            <motion.div variants={cardGrid} className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <motion.div key={img.src} variants={fadeInUp} className="aspect-[3/4] rounded-lg overflow-hidden relative">
      ...
      <section className="py-20 md:py-28 bg-c-surface">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <AnimateOnScroll variant={staggerContainerFast} delay={0.3}>
            <motion.div variants={staggerContainer} className="mt-10 flex flex-wrap justify-center gap-3">
          ...
          <AnimateOnScroll variant={cardGrid} delay={0.2}>
            <motion.div variants={cardGrid} className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <motion.div key={img.src} variants={fadeInUp} className="aspect-square rounded-lg overflow-hidden relative">
                  <Image src={img.src} alt={img.alt} fill className="object-cover" sizes="(max-width: 768px) 50vw, 25vw" />
                </motion.div>
              ))}
            </motion.div>
